...
<div class="md:col-span-2" x-data="{ imgPreview: null }">
    ...
    <template x-if="imgPreview">
        <div class="mt-2">
            <img :src="imgPreview" class="max-h-32 rounded border border-slate-200">
