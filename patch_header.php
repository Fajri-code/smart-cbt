...
$search2 = "            <form method=\"GET\" action=\"{{ route('kartu-ujian.index') }}\">";
$replace2 = "            <div class=\"flex justify-end\">
                <a href=\"{{ route('kartu-ujian.settings') }}\" class=\"inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50\">
